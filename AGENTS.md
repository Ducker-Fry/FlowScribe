...
Project guidance for Codex (Codex.ai/code) when working in this repository.
...
- **Purpose**: Update AGENTS.md, manage Memory, adjust workflows, configure hooks/permissions
...
- Update AGENTS.md only for architectural changes or new patterns
