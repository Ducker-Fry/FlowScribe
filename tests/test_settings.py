...
def test_zh_preset_applies_language_and_prompt_without_forcing_vad(tmp_path: Path) -> None:
...
def test_explicit_vad_filter_still_applies_with_zh_preset(tmp_path: Path) -> None:
    settings = AppSettings.from_options(
        output_dir=tmp_path / "out",
        work_dir=None,
        model_name="small",
